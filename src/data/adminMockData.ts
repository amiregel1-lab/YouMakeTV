...
export const MOCK_CREATORS: AdminCreator[] = [
  {
    ...
    verified: true, kycCompleted: true, status: 'Active', revenueShare: 80,
  ...
  },
  {
    ...
    verified: true, kycCompleted: true, status: 'Active', revenueShare: 70,
  ...
  },
  {
    ...
    verified: false, kycCompleted: false, status: 'Pending', revenueShare: 70,
  ...
  },
  {
    ...
    notes: 'Highest revenue creator. 80% share rate after milestone.',
  },
  {
...
export const MOCK_AUDIT_LOG: AuditLogEntry[] = [
  ...
  { id: 'a-005', timestamp: '2026-06-05T16:40:00Z', action: 'Edited creator', target: 'Nexus Films', targetType: 'creator', performedBy: 'YouMakeTV', details: 'Revenue share updated from 70% to 80% — milestone performance.' },
...
export const DEFAULT_SETTINGS: PlatformSettings = {
  ...
  supportEmail: 'support@youmaketv.ai',
  legalEmail: 'legal@youmaketv.ai',
  defaultCreatorShare: 70,
  premiumCreatorShare: 80,
