  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10">
      ...
      <div className="rounded-[2rem] border border-slate-200/70 bg-white shadow-soft p-8 sm:p-10 space-y-10 divide-y divide-slate-100">
        ...
        <div className="pt-10">
          <Section title="4. Creator Warranties and Representations">
            ...
            <p>
              ...
              <span className="text-brand-purple">info@youmaketv.ai</span> and remove or correct
        ...
        <div className="pt-10">
          <Section title="8. Revenue Share and Payments">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Starter Creator:</strong> 30% of Net Revenue per paid watch (0–999 total paid views);</li>
              <li><strong>Growth Creator:</strong> 35% of Net Revenue per paid watch (1,000–4,999 total paid views);</li>
              <li><strong>Pro Creator:</strong> 40% of Net Revenue per paid watch (5,000+ total paid views).</li>
            </ul>
            <p>
        ...
        <div className="pt-10">
          <Section title="11. Removal of Content">
            <p>
              ...
              <span className="text-brand-purple"> info@youmaketv.ai</span> or using the dashboard
        ...
        <div className="pt-10">
          <Section title="18. Contact">
            ...
            <div className="rounded-2xl bg-slate-50 border border-slate-200 px-5 py-4 space-y-1">
              ...
              <p>Legal: <span className="text-brand-purple">info@youmaketv.ai</span></p>
            </div>
          </Section>
        </div>
      ...
      <p className="text-xs text-center text-slate-400 pb-4">
        Questions about the Creator Agreement? Contact <span className="text-brand-purple">info@youmaketv.ai</span>
      </p>
    </div>
  );
}
